...
public class ModCreativeModeTabs {
    ...
    public static final Supplier<CreativeModeTab> ANCIENT_HORIZONS_TAB_SPAWN_EGGS = CREATIVE_MODE_TAB.register("ancient_horizons_tab_spawn_eggs",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.TIGER_SPAWN_EGG.get()))
                    ...
                    .displayItems((itemDisplayParameters, output) -> {
                        ...
                        output.accept(ModItems.BLACKCAP_SPAWN_EGG);
                        output.accept(ModItems.BLUETHROAT_SPAWN_EGG);
                        output.accept(ModItems.BROWN_BEAR_SPAWN_EGG);
                        output.accept(ModItems.BULLFINCH_SPAWN_EGG);
                        output.accept(ModItems.CICADA_SPAWN_EGG);
                        output.accept(ModItems.CANARY_SPAWN_EGG);
                        output.accept(ModItems.CARDINAL_SPAWN_EGG);
                        output.accept(ModItems.CHAFFINCH_SPAWN_EGG);
                        output.accept(ModItems.CHIMPANZEE_SPAWN_EGG);
                        output.accept(ModItems.CROCODILE_SPAWN_EGG);
                        output.accept(ModItems.CRYODRAKON_SPAWN_EGG);
                        output.accept(ModItems.DEARC_SPAWN_EGG);
                        output.accept(ModItems.DEER_SPAWN_EGG);
                        output.accept(ModItems.DIPLODOCUS_SPAWN_EGG);
                        output.accept(ModItems.DOMESTIC_GOAT_SPAWN_EGG);
                        output.accept(ModItems.EAGLE_SPAWN_EGG);
                        output.accept(ModItems.EARTHWORM_SPAWN_EGG);
                        output.accept(ModItems.ELEPHANT_SPAWN_EGG);
                        output.accept(ModItems.EROMANGASAURUS_SPAWN_EGG);
                        output.accept(ModItems.FISHER_SPAWN_EGG);
                        output.accept(ModItems.GALLIMIMUS_SPAWN_EGG);
                        output.accept(ModItems.GIRAFFE_SPAWN_EGG);
                        output.accept(ModItems.GOLDCREST_SPAWN_EGG);
                        output.accept(ModItems.GOLDFINCH_SPAWN_EGG);
                        output.accept(ModItems.HARE_SPAWN_EGG);
                        ...
                        output.accept(ModItems.SAOLA_SPAWN_EGG);
                        output.accept(ModItems.STOAT_SPAWN_EGG);
                        output.accept(ModItems.TIGER_SPAWN_EGG);
                        output.accept(ModItems.TIT_SPAWN_EGG);
    ...
    public static final Supplier<CreativeModeTab> ANCIENT_HORIZONS_TAB_FOODSTUFFS = CREATIVE_MODE_TAB.register("ancient_horizons_tab_foodstuffs",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.RAW_CHEVON.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(AncientHorizons.MOD_ID, "ancient_horizons_tab_spawn_eggs"))
                    .title(Component.translatable("creativetab.ancienthorizons.ancient_horizons_foodstuffs"))
                    .displayItems((itemDisplayParameters, output) -> {
                        output.accept(ModItems.RAW_CHEVON);
                        output.accept(ModItems.COOKED_CHEVON);
                        output.accept(ModItems.VODKA);
                    }).build());

    public static final Supplier<CreativeModeTab> ANCIENT_HORIZONS_TAB_ANIMAL_TRANSPORTING_STUFFS = CREATIVE_MODE_TAB.register("ancient_horizons_animal_transport",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.DART_GUN.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(AncientHorizons.MOD_ID, "ancient_horizons_tab_foodstuffs"))
                    .title(Component.translatable("creativetab.ancienthorizons.ancient_horizons_transport"))
                    .displayItems((itemDisplayParameters, output) -> {
                            output.accept(ModItems.DART_GUN);
                            output.accept(ModItems.TRANQ_DART);
                }).build());

    public static final Supplier<CreativeModeTab> ANCIENT_HORIZONS_FPAR = CREATIVE_MODE_TAB.register("ancient_horizons_fpar",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.FOSSIL.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(AncientHorizons.MOD_ID, "ancient_horizons_animal_transport"))
                    .title(Component.translatable("creativetab.ancienthorizons.ancient_horizons_fpar"))
                    .displayItems(((itemDisplayParameters, output) ->{
                        output.accept(ModItems.FOSSIL);
                    }))
                    .build());

    public static final Supplier<CreativeModeTab> ANCIENT_HORIZONS_MISC = CREATIVE_MODE_TAB.register("ancient_horizons_misc",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.BELUGA_STURGEON_BUCKET.get()))
                    .withTabsBefore(ResourceLocation.fromNamespaceAndPath(AncientHorizons.MOD_ID, "ancient_horizons_fpar"))
                    .title(Component.translatable("creativetab.ancienthorizons.ancient_misc"))
                    .displayItems(((itemDisplayParameters, output) ->{
                        output.accept(ModItems.BELUGA_STURGEON_BUCKET);
                        output.accept(ModItems.SAOLA_HORN);
