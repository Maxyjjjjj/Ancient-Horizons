...
public class RedPandaAnimations {
    public static final AnimationDefinition RP_STAND = AnimationDefinition.Builder.withLength(0.0417F).looping()
            ...
            .addAnimation("armleft", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                    new Keyframe(0.0F, KeyframeAnimations.degreeVec(-42.5F, 0.0F, -107.5F), AnimationChannel.Interpolations.LINEAR)
            ))
    ...
    public static final AnimationDefinition RP_SLEEP = AnimationDefinition.Builder.withLength(0.0417F).looping()
