...
public class ZebraModel extends HorseModel<ZebraEntity> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            ResourceLocation.fromNamespaceAndPath(AncientHorizons.MOD_ID, "zebra"), "main");
    ...
    @Override
    public void setupAnim(ZebraEntity entity, float limbSwing, float limbSwingAmount,
