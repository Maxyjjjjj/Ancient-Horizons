...
public class TigerModel<T extends TigerEntity> extends HierarchicalModel<T> {
        ...
        public TigerModel(ModelPart root) {
            ...
            this.pawleftfront = body.getChild("pawleftfront");
            this.pawrightfront = body.getChild("pawrightfront");
            this.pawrightback = body.getChild("pawrightback");
            this.pawleftback = body.getChild("pawleftback");
        }
