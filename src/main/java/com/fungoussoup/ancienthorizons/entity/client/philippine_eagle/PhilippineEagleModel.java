...
public class PhilippineEagleModel<T extends PhilippineEagleEntity> extends HierarchicalModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(AncientHorizons.MOD_ID, "philippine_eagle"), "main");
    ...
    public PhilippineEagleModel(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition head = head_base.addOrReplaceChild("head", CubeListBuilder.create().texOffs(0, 56).addBox(-2.0F, -8.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(32, 56).addBox(-0.5F, -7.0F, -5.0F, 1.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(30, 63).addBox(0.0F, -5.0F, -5.0F, 0.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1745F, 0.0F, 0.0F));

        PartDefinition cube_r1 = head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(66, 28).addBox(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -6.0F, -1.0F, 0.0F, -0.3054F, 0.0F));

        PartDefinition cube_r2 = head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(24, 66).addBox(0.0F, -2.0F, 0.0F, 0.0F, 4.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -6.0F, -1.0F, 0.0F, 0.3054F, 0.0F));

        PartDefinition cube_r3 = head.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(16, 63).addBox(-2.0F, 0.0F, 0.0F, 4.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -8.0F, -1.0F, 0.3054F, 0.0F, 0.0F));

        PartDefinition wingleft = body.addOrReplaceChild("wingleft", CubeListBuilder.create().texOffs(40, 28).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 5.0F, 12.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition wingright = body.addOrReplaceChild("wingright", CubeListBuilder.create().texOffs(40, 45).addBox(0.0F, -1.0F, -1.0F, 1.0F, 5.0F, 12.0F, new CubeDeformation(0.0F))
        ...
        PartDefinition legleft = base.addOrReplaceChild("legleft", CubeListBuilder.create().texOffs(64, 62).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.025F))
                .texOffs(66, 35).addBox(-0.5F, 3.0F, 0.5F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.025F))
                .texOffs(32, 62).addBox(-1.5F, 5.0F, -2.0F, 3.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(2.0F, -6.0F, 0.0F));

        PartDefinition legright = base.addOrReplaceChild("legright", CubeListBuilder.create().texOffs(16, 66).addBox(-1.0F, 0.0F, -0.5F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.025F))
                .texOffs(30, 65).addBox(-0.5F, 3.0F, 0.5F, 1.0F, 2.0F, 0.0F, new CubeDeformation(0.025F))
    ...
    @Override
    public void setupAnim(PhilippineEagleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    private void applyFlyingAnimation(float ageInTicks, PhilippineEagleEntity entity) {
