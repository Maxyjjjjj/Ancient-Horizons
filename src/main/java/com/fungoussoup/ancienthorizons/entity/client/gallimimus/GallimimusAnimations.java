...
public class GallimimusAnimations {
        ...
        // Recharge/Rest animation - breathing heavily while recovering stamina
        public static final AnimationDefinition GALLIMIMUS_RECHARGE = AnimationDefinition.Builder.withLength(2.0F).looping()
                .addAnimation("body", new AnimationChannel(AnimationChannel.Targets.ROTATION,
