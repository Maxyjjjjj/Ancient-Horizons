...
public class GroundPathNavigationWide extends GroundPathNavigation {
    private float distancemodifier = 0.75F;

    public GroundPathNavigationWide(Mob entitylivingIn, Level worldIn) {
        super(entitylivingIn, worldIn);
    }

    public GroundPathNavigationWide(Mob entitylivingIn, Level worldIn, float distancemodifier) {
        super(entitylivingIn, worldIn);
