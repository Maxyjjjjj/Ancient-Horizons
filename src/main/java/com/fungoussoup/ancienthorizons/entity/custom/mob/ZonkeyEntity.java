...
public class ZonkeyEntity extends AbstractChestedHorse {
    public ZonkeyEntity(EntityType<? extends ZonkeyEntity> entityType, Level level) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel level, AgeableMob otherParent) {
        return (AgeableMob)EntityType.MULE.create(level);
    }
}
