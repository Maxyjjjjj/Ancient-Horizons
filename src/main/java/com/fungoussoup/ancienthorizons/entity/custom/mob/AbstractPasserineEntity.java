...
public abstract class AbstractPasserineEntity extends ShoulderRidingEntity implements SemiFlyer, DancingAnimal {
    ...
    private void handleFlying() {
        ...
        // Add slight random movement while flying
        if (this.flapTicks % 5 == 0) {
            float yRandom = this.random.nextFloat() * 0.08F - 0.04F;
            this.setDeltaMovement(this.getDeltaMovement().add(0, yRandom, 0));
        }
