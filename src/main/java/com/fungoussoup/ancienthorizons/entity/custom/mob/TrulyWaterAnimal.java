...
public abstract class TrulyWaterAnimal extends Animal {
    ...
    /**
     * Whether this animal needs to surface for air.
     * @return true for air-breathing aquatic animals (whales, dolphins), false for fish
     */
    ...
    /**
     * Standard spawn rule for surface water animals.
     * Spawns between sea level and 13 blocks below, requiring water above and below.
     */
