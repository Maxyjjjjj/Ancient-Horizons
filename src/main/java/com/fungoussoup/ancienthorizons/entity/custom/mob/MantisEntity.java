...
public class MantisEntity extends TamableAnimal implements NeutralMob {
    ...
    private int preyDigestionTime = 0;
    ...
    public void aiStep() {
        ...
        // Handle digestion time
        if (preyDigestionTime > 0) {
            preyDigestionTime--;
            if (preyDigestionTime <= 0) {
                this.heal(4.0F); // Heal when digestion is complete
            }
        }
    ...
    private void onPreyKilled() {
        ...
        setAggressive(false);
        setEating(false);
        preyDigestionTime = 600; // 30 seconds digestion
    ...
    public void addAdditionalSaveData(CompoundTag compound) {
        ...
        compound.putInt("PreyDigestionTime", this.preyDigestionTime);
    ...
    public void readAdditionalSaveData(CompoundTag compound) {
        ...
        this.preyDigestionTime = compound.getInt("PreyDigestionTime");
